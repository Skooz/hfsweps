...
self.Penetrate 		= 5					// How deep Generic Default goes
self.Flightvector 	= self.Entity:GetUp()*((350*52.5)/66)	// Velocity in m/s, FIRST NUMMER is SPEED (FrameTime)
...
self.EffectSize		= 1.15					// How much stuff gets kicked up on impact
self.TissueDamage	= math.Rand(30,40)			// Player damage is multiplied by 2 for some reason
self.BallisticDrag	= 200					// Fraction of velocity lost per tick, higher is less
