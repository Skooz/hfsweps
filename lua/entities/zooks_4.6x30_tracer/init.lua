...
self.Flightvector 	= self.Entity:GetUp()*((725*52.5)/66)	// Velocity in m/s, FIRST NUMMER is SPEED (FrameTime)
...
self.Drift		= 0.25					// How much the bullet will drift in flight (Inaccuracy)
...
Trail:SetKeyValue("startwidth","17")
