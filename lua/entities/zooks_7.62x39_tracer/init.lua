...
self.Penetrate 		= 12					// How deep Generic Default goes
...
self.TissueDamage	= math.Rand(30,55)			// Player damage is multiplied by 2 for some reason
