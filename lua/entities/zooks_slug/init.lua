...
self.Flightvector 	= self.Entity:GetUp()*((360*52.5)/66)	// Velocity in m/s, FIRST NUMMER is SPEED (FrameTime)
...
self.BallisticDrag	= 120					// Fraction of velocity lost per tick, higher is less
